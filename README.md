...
2. 新建一个类，继承`xyz.yuelai.View`类，实现`public String fxml()`方法，此方法指定fxml文件位置。可以指定绝对路径，也可以指定相对路径。
   ...
   ![fxml文件路径](image/image-20201009170359938.png)
...
4. 启动程序
   ![image-20201009170622248](image/image-20201009170622248.png)
...
styleClass分别对应 `.button .button-pramary .button-success .button-info .button-warning .button-danger`![image-20201014164041215](image/image-20201014164041215.png)



RadioButton Checkbox

![image-20201014164232966](image/image-20201014164232966.png)

TextField TextArea

![image-20201014164313467](image/image-20201014164313467.png)

ComboBox

![image-20201014164337408](image/image-20201014164337408.png)

EleSlider（修改自jfoenix JFXSlider）

![image-20201014164642952](image/image-20201014164642952.png)

DatePicker

![image-20201014164739486](image/image-20201014164739486.png)

TableView

![image-20201014165059577](image/image-20201014165059577.png)

ProgressBar

styleClass分别对应 `progress-bar-exception .progress-bar-warning .progress-bar-success .progress-bar`![image-20201014165133225](image/image-20201014165133225.png)

ProgressIndicator

styleClass分别对应 `.progress-indicator .progress-indicator-success .progress-indicator-exception .progress-indicator-warning`
![image-20201014165224767](image/image-20201014165224767.png)

Notification

styleClass分别对应 .notification-info .notification-error.notification-warning .notification-success ![image-20201014165641468](image/image-20201014165641468.png)![image-20201014165659648](image/image-20201014165659648.png)

Message

styleClass分别对应 .message-info .message-error.message-warning .message-success 

![image-20201014170043676](image/image-20201014170102480.png)![image-20201014170211995](image/image-20201014170211995.png)
